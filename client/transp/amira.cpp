...
void amira::on_valdiersup_clicked()
{
...
void amira::on_pushButton_2_clicked()
{
...
void amira::on_appliquer_clicked()
{
...
void amira::on_pushButton_4_clicked()
...
void amira::on_appliquer_2_clicked()
{
...
void amira::on_consulterstatan_clicked()
{
    int x=0;
...
void amira::on_consulterstattic_clicked()
{
    int x=0;
...
void amira::on_valdiersup_released()
{
...
void amira::on_valdiersup_pressed()
{
    son->play();
...
void amira::on_appliquer_released()
{
...
void amira::on_appliquer_pressed()
{
    son->play();
...
void amira::on_consulterstatan_released()
{
...
void amira::on_consulterstatan_pressed()
{
...
void amira::on_pushButton_4_released()
{
...
void amira::on_pushButton_4_pressed()
{
    son->play();
...
void amira::on_ajoutticket_released()
{
...
void amira::on_ajoutticket_pressed()
{
    son->play();
...
void amira::on_pushButton_2_released()
{
...
void amira::on_pushButton_2_pressed()
{
    son->play();
...
void amira::on_appliquer_2_released()
{
...
void amira::on_appliquer_2_pressed()
{
    son->play();
...
void amira::on_trier_2_released()
...
void amira::on_pushButton_6_released()
{
...
void amira::on_pushButton_6_pressed()
{
    son->play();
...
void amira::on_consulterstattic_released()
{
...
void amira::on_consulterstattic_pressed()
{
    son->play();
...
void amira::on_lineEdit_5_textChanged(const QString &arg1)
{
   // QString id = ui->lineEdit_5->text();
...
void amira::on_taban_activated(const QModelIndex &index)
{

}

void amira::on_taban_2_activated(const QModelIndex &index)
{
    QString id=ui->taban_2->model()->data(index).toString();
    ui->lineEdit_id->setText(id);
}

void amira::on_lineEdit_10_textChanged(const QString &arg1)
{
    ui->tabticrec->setModel(tmpticket.afficherrecherche(arg1));
}

void amira::on_tabticsup_activated(const QModelIndex &index)
{
...
void amira::on_pushButton_7_clicked()
{
...
void amira::mailSent(QString status)
{
